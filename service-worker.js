const CACHE_NAME = "hutao-blog-v41";
const APP_SHELL = [
  "./",
  "./index.html",
  "./articles.html",
  ...
  "./assets/next/ui_card_dark_ink_glass.png",
  "./assets/next/ui_dialog_parchment_small.png",
  "./assets/next/ui_input_brush_frame.png",
  "./assets/next/ui_panel_parchment_large.png",
  ...
  "./assets/minimal-ink/dialog_panel_washi.png",
  "./assets/minimal-ink/petals_minimal_sprite.png",
  "./assets/minimal-ink/scroll_mist_minimal.png",
  "./assets/minimal-ink/scroll_mountain_line_minimal.png",
  "./assets/minimal-ink/text_panel_ink_glass.png",
  "./assets/minimal-ink/text_panel_minimal_paper.png",
  "./assets/minimal-ink/toast_seal_banner_minimal.png",
  "./assets/minimal-ink/transition_ink_veil.png",
  "./assets/minimal-ink/video_card_ink_dark.png",
  "./assets/minimal-ink/video_card_minimal_light.png",
  "./assets/minimal-ink/video_card_washi_warm.png",
  "./assets/minimal-ink/video_thumb_ink_overlay.png",
