...
export const capabilities = [
  ...
  { title: "Live2D 与数字角色", icon: Cuboid, text: "角色展示、状态交互和叙事界面方案。" },
];

export const skillGroups = [
  { title: "前端", items: ["Next.js", "React", "TypeScript", "Tailwind CSS"] },
  { title: "动效", items: ["Motion for React", "GSAP", "ScrollTrigger", "Lottie"] },
  { title: "视觉", items: ["AI Image Workflow", "Photoshop", "Typography", "Responsive Design"] },
